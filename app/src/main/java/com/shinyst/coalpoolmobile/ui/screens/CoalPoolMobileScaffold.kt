package com.shinyst.coalpoolmobile.ui.screens
...
@Composable
fun CoalPoolMobileScaffold(title: String, displayTopBar: Boolean, modifier: Modifier = Modifier, screenContent: @Composable () -> Unit) {
