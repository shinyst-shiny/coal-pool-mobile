...
import com.shinyst.coalpoolmobile.data.models.EncryptedKeypair
import com.shinyst.coalpoolmobile.data.models.Ed25519PrivateKey
...
class KeypairRepository(private val context: Context) : IKeypairRepository {
    ...
    override fun generateNewKeypairWithPhrase(): GeneratedKeypair {
        val generatedKey = uniffi.coalpoolmobileffi.generateKey()
